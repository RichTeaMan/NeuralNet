...
{
    [TestClass]
    public class ReluBackPropagationTest
    {
        [TestMethod]
        public void LogicNodeOR()
        {
            Node node = new ReluNode(2, new Random());
        ...
        {
            var nodes = Enumerable.Range(0, 1).Select(n => new ReluNode(2, new Random())).ToList();
        ...
        {
            var nodes = Enumerable.Range(0, 2).Select(n => new ReluNode(2, new Random())).ToList();
            var NodeLayer = new NodeLayer(nodes);
        ...
        {
            Net Net = new NetFactory().GenerateRandomReluNet(2, 1, 2, new Random());
        ...
        {
            Net Net = new NetFactory().GenerateRandomReluNet(2, 3, 2, new Random());
